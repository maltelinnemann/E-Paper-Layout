...
def generate_layout():
    ...
    img_red.paste(iconDay(layout.days[0]), (175 - math.ceil(iconDay(layout.days[0]).width / 2), 310 if layout.days[0] == cloudIcon else 320))
    ...
    img_red.paste(iconDay(layout.days[1]), (475 - math.ceil(iconDay(layout.days[1]).width / 2), 310 if layout.days[1] == cloudIcon else 320))
    ...
    img_red.paste(iconDay(layout.days[2]), (655 - math.ceil(iconDay(layout.days[2]).width / 2), 310 if layout.days[2] == cloudIcon else 320))
